(function ($) {
  ...
  $(document).ready(function () {
    ...
    //=======================================================================
    $(
      ".course__sort-inner select, .panel-body .form-group select"
    ).niceSelect();
    ...
    $(".shop-details-sm-images").slick({
      ...
      focusOnSelect: true,
      prevArrow:
        '<button class="shop-slick-prev"><i class="icofont-thin-left"></i></button>',
      nextArrow:
        '<button class="shop-slick-next"><i class="icofont-thin-right"></i></button>',
    });
    ...
    $(".blog-image-slider").slick({
      ...
      slidesToScroll: 1,
      prevArrow:
        '<button class="blog-slider-btn"><i class="icofont-caret-left"></i></button>',
      nextArrow:
        '<button class="blog-slider-btn btn-next"><i class="icofont-caret-right"></i></button>',
    });
